...
import { Menu, X, User, MessageCircle, Instagram, DiscIcon as Discord } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="https://wa.me/5531982382635?text=Ol%C3%A1%2C%20gostaria%20de%20falar%20com%20um%20especialista!" target="_blank" className="flex items-center gap-2 rounded-full bg-indigo-500 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-600 transition-colors">
          ...
          >
            <div className="space-y-1 px-4 pb-3 pt-2">
              ...
              <div className="mt-4 border-t border-white/5 pt-4 pb-2">
                ...
                <Link
                  href="https://wa.me/5531982382635?text=Ol%C3%A1%2C%20gostaria%20de%20falar%20com%20um%20especialista!" target="_blank"
                  onClick={() => setIsMobileMenuOpen(false)}
